...
public class Twain
	...
	public void Acquire()
		...
		guif.ShowUI = 1; //20111111 Ed Borlas - it used to be = 1 if it's 1, it won't take the picture.
		guif.ModalUI = 1; // 20111111 Ed Borlas - It used to be = 1 no difference if it's 0 or 1
		guif.ParentHand = hwnd; //20111111 Ed Borlas - it used to be = hwnd no difference if it's hwnd or this.winmsg.hwnd
