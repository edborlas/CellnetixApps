...
namespace RFIDeas_pcProxAPI
{
    ...
    static class pcProxDLLAPI
    {
        ...
        [DllImport("pcProxAPI.dll")] public static extern ushort SetCardType(ushort cardType);
        ...
        [DllImport("pcProxAPI.dll")] public static extern char getPartNumberString_char(ushort index);
        ...
        [DllImport("pcProxAPI.dll")] public static extern short getTimeParms_iPad5();
        ...
        [DllImport("pcProxAPI.dll")] public static extern ushort setTimeParms_iPad5(short value);
